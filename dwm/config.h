...
static const char *fonts[]     = {/*"SauceCodePro Nerd Font Mono:weight=bold:size=11:antialias=true:hinting=true",*/
				  "Source Code Pro:style=Bold:size=11:antialias=true:hinting=true",
	                            /*  "Mononoki:size=10:antialias=true:autohint=true", */
                                 /*  "Hack:size=10:antialias=true:autohint=true", */
                                 /* "JoyPixels:size=10:antialias=true:autohint=true", */
				  "Font Awesome 5 Free,Font Awesome 5 Free Regular:style=Regular:size=13:antialias=true:autohint=true",
				  "Font Awesome 5 Brands,Font Awesome 5 Brands Regular:style=Regular:size=13:antialias=true:autohint=true",
				  "Font Awesome 5 Free,Font Awesome 5 Free Solid:style=Solid:size=13:antialias=true:autohint=true"
						     	};
static const char col_1[]  = "#282a36"; /* background color of bar */
static const char col_2[]  = "#282c36"; /* border color unfocused windows */
static const char col_3[]  = "#f8f8f2";
static const char col_4[]  = "#44475a"; /* border color focused windows and tags */
/* bar opacity 
...
static Key keys[] = {
	/* Custom Calls */
	{ MODKEY,		-1,        XK_Print,  spawn,	      CMD("/home/tandalos/packages/cscripts/pscreen")},
	{ Mod1Mask,		-1,	   XK_Caps_Lock,   spawn,          CMD("/home/tandalos/packages/cscripts/kblayout")},
	{ MODKEY,		-1,	   XK_Up,     spawn,	      CMD("/home/tandalos/packages/cscripts/volume +")},
	{ MODKEY,		-1,	   XK_Down,   spawn,	      CMD("/home/tandalos/packages/cscripts/volume -")},
	{ MODKEY,		-1,	   XK_Right,  spawn,	      CMD("/home/tandalos/packages/cscripts/bright +")},
	{ MODKEY,		-1,	   XK_Left,   spawn,	      CMD("/home/tandalos/packages/cscripts/bright -")},
